        ...
        <article id="fullArticle">
            ...
            <div id="CustomiseSearch">
                <form action="" method="post">
                    ...
                    <button id="RefineSearch" class="GeneralButton" type="submit">Refine List</button>
                    ...
                    <a href="<?= PROJECT_URL . 'productspec' . '/' . $product->getSpecificationURL() ?>">
                        <div class="ProductImage">
                            ...
                            <p style="font-size: 0.9em;">
                                <?PHP
                                if ($product->getPeriodicalDate() > '1000-01-01')
                                    echo $product->getPeriodicalDate();
                                ?>
                            </p>
                            $ <?= $product->getPrice(); ?>
                            <br>
                            ...
                            if ($product->getInStock() > 0)
                                echo "<p id='InStock'>In Stock (" . $product->getInStock() . ")</p>";
                            else
                                echo "<p id='OutOfStock'>Out Of Stock</p>";
                            ?>
                        </div>
                        <div class="ProductDesc"><b><?= $product->getProductTitle(); ?></b>
                            <p style="padding: 10px;">by: </p><br><b><?= $product->getAuthor(); ?></b>
                        </div>
                    </a>
                </div>
                <?PHP
